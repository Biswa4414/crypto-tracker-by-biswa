...
function DashboardPage() {
  ...
  const handlePageChange = (event, value) => {
    setPageNumber(value);                                                   //value =2
    var startingIndex = (value - 1) * 10;                                   // startingIndex = (2-1)*10 = 10
    setPaginatedCoins(coins.slice(startingIndex, startingIndex + 10));      //11 to 20 (coins) show when we click page 2
  };
      ...
      {loading ? (
        ...
        <div style={{ minHeight: "90vh" }}>
          ...
          <TabsComponent
            ...
            setSearch={setSearch}
          />
          {!search && (             // if no search it default show 1st page coin 1 to 10
            <PaginationComponent
